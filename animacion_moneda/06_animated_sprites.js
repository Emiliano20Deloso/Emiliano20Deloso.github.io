...
class Game {
    ...
    initObjects() {
        ...
        this.coins = [
            new Coin(new Vec(320, 450), 32, 32, "yellow", "coin", 8),
            new Coin(new Vec(570, 90), 32, 32, "yellow", "coin", 8),
            new Coin(new Vec(650, 315), 32, 32, "yellow", "coin", 8),
            new Coin(new Vec(150, 123), 32, 32, "yellow", "coin", 8),
            new Coin(new Vec(25, 12), 32, 32, "yellow", "coin", 8),
            new Coin(new Vec(100, 420), 32, 32, "yellow", "coin", 8),
            new Coin(new Vec(700, 30), 32, 32, "yellow", "coin", 8),
        ];
